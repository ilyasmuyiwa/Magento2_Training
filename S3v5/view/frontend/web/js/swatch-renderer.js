...
define([
    ...
    $.widget('mage.SwatchRenderer', {
        ...
        _syncDesc: function() {
            var productID = document.getElementsByName('product')[0].value;
              var superAttribute = {};
              $('.swatch-attribute').each(function () {
                  superAttribute[$(this).attr('attribute-id')] = $(this).attr('option-selected');
              });
              ...
              $.ajax({
                   method: "POST",
                   url: "http://127.0.0.1/laynav/customswatch/ajax/index",
                   data: data
              }).done(function (data) {
